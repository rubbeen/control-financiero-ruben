...
1. Confirma en Firebase Authentication que la cuenta propietaria autorizada esta verificada y anota su UID fuera del repositorio.
...
7. Revisa el JSON local creado por la migracion y cada `needsReview`; no publiques el reporte ni datos reales.
